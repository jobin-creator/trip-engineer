...
import { calcNights, buildStylePreview, StyleForm } from "@/lib/tripUtils";
        ...
        <section className="form-card" aria-label="Trip planner">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {/* ══════════════════════════════════════
                TAB 1 — Trip details
            ══════════════════════════════════════ */}
            <div role="tabpanel" className={`tab-panel${activeTab !== "trip" ? " tab-panel-hidden" : ""}`}>
            ...
            {/* ══════════════════════════════════════
                TAB 2 — Your style
            ══════════════════════════════════════ */}
            <div role="tabpanel" className={`tab-panel${activeTab !== "style" ? " tab-panel-hidden" : ""}`}>
            ...
            {/* ══════════════════════════════════════
                TAB 3 — Travel info
            ══════════════════════════════════════ */}
            <div role="tabpanel" className={`tab-panel${activeTab !== "travel" ? " tab-panel-hidden" : ""}`}>
